...
function TableComponent({ columns, data }) {
  return (
    ...
    <div className="inline-block container container-fuid align-items-center d-flex justify-content-center p-0">
      <div
        className="p-2 md:pt-0 w-100 bg-gray-200"
        style={{ borderRadius: "10px" }}
      >
        {" "}
        {/* cái này để đồng bộ với cái border table cho đẹp*/}
            ...
            <div key={user.id} className="mb-2 w-100 rounded-md bg-white p-4">
              <div className="d-flex justify-content-between pb-4">
                ...
                <div className="d-flex justify-content-end">
                  <div>
                    <p className="h5 font-weight-medium mb-0">{user.amount}</p>
        ...
        <table className="table table-hover table-sm">
          <thead>
            <tr>
              <th
                scope="col"
                className="px-3 py-4 text-left bg-gray-200"
                style={{ border: "none" }}
              >
                Customer
              </th>
              <th
                scope="col"
                className="px-2 py-4 text-left bg-gray-200"
                style={{ border: "none" }}
              >
                Email
              </th>
