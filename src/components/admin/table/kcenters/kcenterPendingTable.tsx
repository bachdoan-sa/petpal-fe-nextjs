...
export default async function PendingKCenterTable({ query, currentPage }) {
    ...
    try {
        const response = await kcenterApiRequest.getListPagePendingCareCenter({ body, sessionToken });
