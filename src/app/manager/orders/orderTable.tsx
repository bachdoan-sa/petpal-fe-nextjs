...
export default function orderTable({ query, currentPage, sessionToken }) {
                        ...
                        <table className="table table-hover table-sm">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" className="px-2 py-4 text-left bg-gray-200" style={{ border: "none" }}>Giá dịch vụ</th>
                                    ...
                                    <tr key={order.id} className="text-sm">
                                        <td className="p-2 text-left">
                                            <div className="d-flex items-center be-box">
                                                ...
                                                {/* <p className="table-first-td">{order.pet?.fullName ?? "Chưa có tên"}</p> */}
                                            </div>
                                        </td>
                                        {/* <td className="p-2 text-left">{order.package?.title ?? "Không có tên"}</td> */}
